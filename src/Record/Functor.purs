...
-- import Type.Data.Symbol (class Equals, class IsSymbol, SProxy(SProxy))
...
-- instance nonRefl :: TypeEquals_ False t0 t1
--   where
--   to = unsafeCrashWith message
--   from x = unsafeCrashWith message
-- instance refl :: TypeEquals_ True t t
--   where
--   to   x = x
--   from x = x
